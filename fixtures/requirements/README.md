...
pnpm start -- --questionnaire fixtures/requirements/project-requirements-core.json

# Run with custom data directory for stakeholder sessions
pnpm start -- --questionnaire fixtures/requirements/project-requirements-core.json --data ./sessions/stakeholder-a

# Resume an interrupted session
pnpm start -- --questionnaire fixtures/requirements/project-requirements-core.json --resume <sessionId>
```

### Exporting to Markdown

```bash
pnpm run markdown-convert -- \
...
pnpm start -- -q fixtures/requirements/project-requirements-core.json -d ./sessions/tech-lead
pnpm start -- -q fixtures/requirements/project-requirements-core.json -d ./sessions/product-owner
pnpm start -- -q fixtures/requirements/project-requirements-core.json -d ./sessions/business-stakeholder
