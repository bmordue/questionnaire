...
function printHelp(): void {
  console.log(
    [
      'Usage:',
      '  ppnpm start -- --questionnaire <path> [--resume <sessionId>] [--data <directory>] [--storage-module <module>]',
      '  ppnpm run start:dev -- --questionnaire <path> [--resume <sessionId>] [--data <directory>]',
      '',
      'Options:',
